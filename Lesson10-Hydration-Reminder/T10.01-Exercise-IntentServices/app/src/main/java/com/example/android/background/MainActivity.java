...
public class MainActivity extends AppCompatActivity implements
    ...
    ChargingBroadCastReciever mChargingReciever;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReminderUtilities.scheduledCharginfRemindr(this);
        ...
        mChargingReciever = new ChargingBroadCastReciever();
    }
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingReciever, mIntentFilter);
    }
